...
🌡 Real-time temperature & humidity monitoring (°C / °F)

🔋 Compact 14250 battery (smaller than 18650) with onboard charging

💡 LED indicator (blinks every 5s in daylight mode)
